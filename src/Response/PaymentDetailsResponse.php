...
final readonly class PaymentDetailsResponse
{
     ...
     * @param string|null       $opaque             Wire key `Opaque`. Echoed from InitPayment; the echo is what proved §4.4's parameter overwrite. Observed surviving four channels, not one: this response (P3), the callback (P2), and the RefundPayment and CancelPayment responses (P4.1, P5).
